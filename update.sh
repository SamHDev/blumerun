...
DATAE=`wget -q -O - --no-cache "https://raw.githubusercontent.com/SamHDev/blumerun/master/version.txt"`
...
sudo wget -q --no-cache https://raw.githubusercontent.com/SamHDev/blumerun/master/updater.sh -P /usr/local/blumerun
